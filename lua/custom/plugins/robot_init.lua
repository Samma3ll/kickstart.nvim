...
--       settings = {
--         robot = {
--           configurationFile = '/Users/goinn00/git/pga-robot/robot.yaml',
--           python = {
--             executable = '/Users/goinn00/git/pga-robot/.venv/bin/python',
--           },
--           variables = {
--             EXECDIR = '/Users/goinn00/git/pga-robot/',
--           },
--           variableFiles = {
--             '/Users/goinn00/git/pga-robot/variables.py',
--           },
--           args = {
--             '--variablefile',
--             '/Users/goinn00/git/pga-robot/variables.py',
...
--           robocop = {
--             enabled = true,
--             path = '/Users/goinn00/git/pga-robot/.venv/bin/robocop',
--             config = '/Users/goinn00/git/pga-robot/pyproject.toml',
--           },
--         },
--       },
--       filetypes = { 'robot' },
...
--
--   -- check robocop
--   if client.config.settings and client.config.settings.robot and client.config.settings.robot.robocop and client.config.settings.robot.robocop.enabled then
--     print 'robocop is enabled.'
--     if client.config.settings.robot.robocop.path then
--       print('robocop path: ' .. client.config.settings.robot.robocop.path)
--     else
--       print 'robocop path is not specified.'
--     end
--   else
--     print 'robocop is not enabled.'
--     return false
--   end
--
